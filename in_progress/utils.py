...
class DataProcessor(object):
    ...
    def _load_glove(self,dim):
        ...
        path = "/home/vivek/research/text_classification/data/glove/glove.6B." + str(dim) + 'd'
...
class TFRecordLoader(object):
    def __init__(self,file_name):
        ...
        self.dataset = tf.data.TFRecordDataset([file_name] if type(file_name) !=list else file_name)
    ...
    def get_input(self,epochs,batch_size):
